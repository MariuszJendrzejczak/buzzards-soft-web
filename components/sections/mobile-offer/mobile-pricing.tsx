...
import { MobileOrderButton } from "@/components/sections/mobile-offer/order-button";
...
const TIERS = ["start", "full", "custom"] as const;

export async function MobilePricing() {
  const t = await getTranslations("mobileOffer.pricing");

  const rows: FeatureRow[] = [
    {
      labelKey: "audience",
      start: t("start.audience"),
    ...
    },
    {
      ...
      start: t("start.scope"),
      full: t("full.scope"),
      custom: t("custom.scope"),
    },
    {
      labelKey: "screens",
      start: t("start.screens"),
      full: t("full.screens"),
      custom: t("custom.screens"),
    },
    {
      labelKey: "timeline",
      start: t("start.timeline"),
      full: t("full.timeline"),
      custom: t("custom.timeline"),
    },
  ];

  return (
    <section
      id="mobile-offer-pricing"
      aria-labelledby="mobile-offer-pricing-heading"
      className="relative isolate border-t border-border/60 py-20 sm:py-28"
    >
      <div className="mx-auto w-full max-w-7xl px-6 sm:px-8">
        <ScrollReveal as="header" className="max-w-3xl">
          <h2
            id="mobile-offer-pricing-heading"
