...
export async function MobileAudience() {
  const t = await getTranslations("mobileOffer.audience");

  return (
    <section
      id="mobile-offer-audience"
      aria-labelledby="mobile-offer-audience-heading"
      className="relative isolate border-t border-border/60 py-20 sm:py-28"
    >
      <div className="mx-auto w-full max-w-3xl px-6 sm:px-8">
        <ScrollReveal as="header">
          <h2
            id="mobile-offer-audience-heading"
